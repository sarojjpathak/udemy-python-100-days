...
#     gr = "hi"
#     print(gr)
# print(gr)#print hello
# greet()#print hi
# print(gr)#print hi as global variable is changed


# #globa variable cannot be manipulated directly inside the local variable so to modify that we have to use global keyword
